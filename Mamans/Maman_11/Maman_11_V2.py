...
class Chess:
    def __init__(self):
        self.piece_locations_dict = {}

    def get_next_piece_location_input(self) -> None:
        piece_location = self.get_piece_location_from_input()
        piece_type = self.get_piece_type_from_input()
        append_pi
...
def main():
    current_piece_position = get_piece_position_from_user_input()